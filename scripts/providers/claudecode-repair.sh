...
CLAUDE_CODE_BIN="${AUTO_FIX_OPENCLAW_CLAUDE_CODE_BIN:-$(command -v claude || command -v claude-code || true)}"
CLAUDE_CODE_MODEL="${AUTO_FIX_OPENCLAW_CLAUDE_CODE_MODEL:-}"
CLAUDE_CODE_TIMEOUT_SECS="${AUTO_FIX_OPENCLAW_CLAUDE_CODE_TIMEOUT_SECS:-300}"
CLAUDE_CODE_ARGS_TEMPLATE="${AUTO_FIX_OPENCLAW_CLAUDE_CODE_ARGS_TEMPLATE:-exec --full-auto --cwd \"$HOME\" --prompt-file \"{PROMPT_FILE}\"}"
